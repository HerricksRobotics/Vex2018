...
#pragma config(Motor,  port6,           mobileLift2,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           frontMotor,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           rightArm,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port9,           leftArm,       tmotorVex393HighSpeed_MC29, openLoop, reversed)

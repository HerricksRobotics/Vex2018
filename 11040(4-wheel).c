...
#pragma config(Motor,  port10,          RightBack,    tmotorVex393_MC29, openLoop, reversed)

// RC CODE FOR THE VEX ROBOT 11040A (If can be equiped with 4-motor drive)
// If wanting to do this, Y-cable the 2 armLift motors
